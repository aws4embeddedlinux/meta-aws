...
do_compile_ptest() {
    ...
    ${CC} ${CFLAGS} ${LDFLAGS} -I${S}/include -I${S}/priv_include \
        -o ${B}/test-basic-api ${WORKDIR}/sources/test-basic-api.c -L${B}/lib -lggl-sdk -lpthread

    ${CC} ${CFLAGS} ${LDFLAGS} -I${S}/include -I${S}/priv_include \
        -o ${B}/test-json-ops ${WORKDIR}/sources/test-json-ops.c -L${B}/lib -lggl-sdk -lpthread
}
