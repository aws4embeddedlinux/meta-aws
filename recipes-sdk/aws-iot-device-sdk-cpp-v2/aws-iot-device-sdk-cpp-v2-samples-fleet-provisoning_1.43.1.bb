...
S = "${UNPACKDIR}/${BP}/samples/service_clients/fleet_provisioning/provision-basic"
...
do_install() {
 install -d ${D}${bindir}
 install ${B}/fleet-provisioning-basic ${D}${bindir}/aws-iot-device-sdk-cpp-v2-samples-fleet-provisoning
}
