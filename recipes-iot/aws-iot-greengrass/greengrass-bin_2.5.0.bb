...
SRC_URI                    = "https://d2s8p88vqu9w66.cloudfront.net/releases/greengrass-2.5.0.zip;name=payload; \
                              ...
                              "
SRC_URI[payload.md5sum]    = "a7cbf11dbbb2ea8cc306db15934b4dd9"
SRC_URI[payload.sha256sum] = "6895b5a607d0f2c9d668645fa81b2d4cd76859011ba0177dd4165c2dc0f28889"
...
do_install() {
    ...
    cd ${GG_ROOT}/alts
    ln -s /${GG_ROOT}/alts/init current
