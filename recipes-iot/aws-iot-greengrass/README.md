...
When enabling Fleet provisioning `PACKAGECONFIG = "fleetprovisioning"`
` it is important to provide claim certificates and place them in the `fleetprovisioning` dir:
```
meta-aws
└── recipes-iot
    └── aws-iot-greengrass
